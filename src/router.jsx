...
const Router = () => {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/login"
        element={!user ? <Login /> : <Navigate to={HOME_BY_ROLE[user.role] || "/login"} replace />}
      />
      <Route
        path="/register"
        element={!user ? <Register /> : <Navigate to={HOME_BY_ROLE[user.role] || "/login"} replace />}
      />
      <Route
        path="/forgot"
        element={!user ? <Forgot /> : <Navigate to={HOME_BY_ROLE[user.role] || "/login"} replace />}
      />
      <Route
        path="/reset"
      ...
      />
      <Route
        path="/industry/internships/:id/edit"
        element={
          <RoleGuard roles={["industry_liaison", "liaison", "super_admin"]}>
            <LiaisonInternshipForm />
          </RoleGuard>
      ...
      <Route
        path="/"
        element={user ? <Navigate to={HOME_BY_ROLE[user.role]} replace /> : <Navigate to="/login" replace />}
      />
